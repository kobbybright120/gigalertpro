...
function SourceBadge({ platform }) {
  const icons = {
    ...
    RemoteOK: <Briefcase className="w-3.5 h-3.5" />,
    Wellfound: <Rocket className="w-3.5 h-3.5" />,
    WorkingNomads: <Globe className="w-3.5 h-3.5" />,
    OpenQuant: <TrendingUp className="w-3.5 h-3.5" />,
  };
  ...
  const configs = {
    ...
    RemoteOK: { bg: "bg-emerald-500/8 border-emerald-500/15 text-emerald-400" },
    Wellfound: { bg: "bg-sky-500/8 border-sky-500/15 text-sky-400" },
    WorkingNomads: { bg: "bg-teal-500/8 border-teal-500/15 text-teal-400" },
    OpenQuant: { bg: "bg-violet-500/8 border-violet-500/15 text-violet-400" },
  };
