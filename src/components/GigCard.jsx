...
function SourceBadge({ platform }) {
  ...
  const configs = {
    ...
    Instagram: { bg: "bg-pink-500/8 border-pink-500/15 text-pink-400" },
    TikTok: { bg: "bg-gray-500/8 border-gray-500/15 text-gray-200" },
    YouTube: { bg: "bg-red-500/8 border-red-500/15 text-red-400" },
  };
