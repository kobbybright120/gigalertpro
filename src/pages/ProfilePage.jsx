          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                title="Email us"
                className="inline-flex items-center justify-center p-2.5 bg-white/[0.04] border border-white/[0.06] rounded-xl text-gray-300 hover:text-[#00F0B5] hover:border-[#00F0B5]/20 transition-all duration-200"
              >
